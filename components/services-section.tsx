...
import { Megaphone, Globe, Store } from "lucide-react";
...
const services = [
  {
    ...
    description:
      "من الفكرة إلى الشهرة والانتشار، بدون عناء. نقدّم لك فريقًا متخصصًا لإدارة التسويق بالكامل.",
    color: "bg-primary",
    href: "#marketing",
  },
  {
    ...
    description:
      "إدارة الحسابات، صناعة المحتوى، جدولة المنشورات، والتفاعل مع الجمهور لبناء علامة تجارية قوية.",
    color: "bg-chart-1",
    href: "#trips",
  },
  {
    ...
    description:
      "تصميم وتطوير مواقع ومتاجر إلكترونية احترافية متوافقة مع جميع الأجهزة وتدعم نمو أعمالك.",
    color: "bg-chart-2",
    href: "#printing",
  },
];
        ...
        <ScrollReveal>
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              فريق متخصص لكل مجال يضمن لك التنفيذ الاحترافي
            </p>
          </div>
        </ScrollReveal>
